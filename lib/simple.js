 ...
 */
    ...
    */
     ...
     * @param {Object} options
     */
    async reply2(jid, text, title, body, link, buffer, quoted, options = {}) {
    return await this.sendMessage(jid, text, MessageType.text, { contextInfo: { mentionedJid: this.parseMention(text) , quoted, externalAdReply: {title: title, body: body, previewType:"2", thumbnail: buffer, sourceUrl: link }}})
    }
